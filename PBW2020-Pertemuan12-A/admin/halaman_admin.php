        ...
        <div class="content">
            <div class="container-fluid mt-2">
                ...
                <table class="table table-bordered">
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            <tr>
                                ...
                                <td class='text-center'>
                                    <a class='btn btn-success' href='edit_admin.php?id=".$data['id']."'>
                                        <i class='fa fa-pencil' aria-hidden='true'></i>
                                    </a>
                                    <a class='btn btn-danger' href='hapus_admin.php?id_mhs=".$data['id']."'>
                    ...
                    <a href="tambah_admin.php" class="btn btn-primary">Tambah User</a>
            </div>
        </div>
    </div>
</body>
